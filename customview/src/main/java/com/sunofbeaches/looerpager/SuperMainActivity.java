...
public class SuperMainActivity extends AppCompatActivity {
    ...
    private void initData() {
        mData.add(new PagerItem("努比亚Z40S Pro星空典藏版", R.drawable.pic1));
        mData.add(new PagerItem("中兴远航40 Pro+",R.drawable.pic2));
        mData.add(new PagerItem("中兴远航30S",R.drawable.pic3));
        mData.add(new PagerItem("努比亚Z40S Pro",R.drawable.pic4));
    }
